...
function renderBenchmark(data){
    ...
    el.innerHTML=
    `<b>${intensity.toFixed(3)}</b> tCOÃ¢â€šâ€š / unit<br>
...
function renderReduction(data){
    ...
    el.innerHTML=`<b>${reduction.toFixed(2)} tCOÃ¢â€šâ€š</b><br>Potential reduction`
    el.parentElement.style.background="linear-gradient(135deg,#14532d,#020617)"
...
async function exportPDF(){
    ...
    // Ã¢ÂÂ³ pastikan chart sudah render
    await new Promise(r => setTimeout(r, 300));
    // Ã°Å¸â€Â¥ force style terang sebelum export
if (energyChart) {
